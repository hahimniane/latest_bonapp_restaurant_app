...
enum DrawerSelection { Orders, DineIn, DineInReq, ManageProducts, AddRestauarnt, createTable, addStory, Offers, SpecialOffer, inbox,WorkingHours, Profile, Wallet, BankInfo, termsCondition, privacyPolicy,chooseLanguage, Logout }
